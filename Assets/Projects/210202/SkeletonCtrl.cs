...
public class SkeletonCtrl : MonoBehaviour, IDamageable
{
    public float colorH;
    ...
    void Update()
    {
        if(RGBmode)
		{
            ...
            _renderer.materials[0].SetColor("_EmissionColor2", newColor);
		...
		{
            _renderer.materials[0].SetColor("_EmissionColor2", new Color(18.0f, 0.3f, 0.3f));
        }
    }
